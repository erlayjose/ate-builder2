    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-slate-600 mb-8 max-w-md">Crea y gestiona actividades pedagógicas estructuradas en 5 fases, con exportación a PDF.</p>
          <a href={getLoginUrl()}>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100">
      ...
      <div className="max-w-4xl mx-auto p-6">
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <p className="text-slate-600 mb-6">Accede al constructor de Actividades Tecnológicas Escolares para crear documentos estructurados en 5 fases pedagógicas.</p>
